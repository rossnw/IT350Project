...
class PackageController extends AppBaseController
{
	...
	public function Query()
	{
		try
		{
			...
			if ($filter) $criteria->AddFilter(
				new CriteriaFilter('Packagename,Parts,Vin'
				, '%'.$filter.'%')
			);
	...
	public function Create()
	{
		try
		{
			...
			$package->Packagename = $this->SafeGetVal($json, 'packagename');
			$package->Parts = $this->SafeGetVal($json, 'parts');
			$package->Vin = $this->SafeGetVal($json, 'vin');
	...
	public function Update()
	{
		try
		{
			...
			$package->Packagename = $this->SafeGetVal($json, 'packagename', $package->Packagename);
			$package->Parts = $this->SafeGetVal($json, 'parts', $package->Parts);
			// this is a primary key.  uncomment if updating is allowed
			// $package->Vin = $this->SafeGetVal($json, 'vin', $package->Vin);
