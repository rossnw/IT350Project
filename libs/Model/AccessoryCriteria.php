...
require_once("DAO/AccessoryCriteriaDAO.php");

/**
 * The AccessoryCriteria class extends AccessoryDAOCriteria and is used
 ...
 * @version 1.0
 */
class AccessoryCriteria extends AccessoryCriteriaDAO
{
