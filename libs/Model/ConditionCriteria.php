...
require_once("DAO/ConditionCriteriaDAO.php");

/**
 * The ConditionCriteria class extends ConditionDAOCriteria and is used
 ...
 * @version 1.0
 */
class ConditionCriteria extends ConditionCriteriaDAO
{
