...
require_once("DAO/CarinstanceCriteriaDAO.php");

/**
 * The CarinstanceCriteria class extends CarinstanceDAOCriteria and is used
 ...
 * @version 1.0
 */
class CarinstanceCriteria extends CarinstanceCriteriaDAO
{
