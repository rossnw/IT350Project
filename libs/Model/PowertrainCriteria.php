...
require_once("DAO/PowertrainCriteriaDAO.php");

/**
 * The PowertrainCriteria class extends PowertrainDAOCriteria and is used
 ...
 * @version 1.0
 */
class PowertrainCriteria extends PowertrainCriteriaDAO
{
