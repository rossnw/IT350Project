...
require_once("DAO/TimeframeCriteriaDAO.php");

/**
 * The TimeframeCriteria class extends TimeframeDAOCriteria and is used
 ...
 * @version 1.0
 */
class TimeframeCriteria extends TimeframeCriteriaDAO
{
