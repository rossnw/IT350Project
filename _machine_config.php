...
GlobalConfig::$CONNECTION_SETTING->DBName = "cars";
GlobalConfig::$CONNECTION_SETTING->Username = "root";
GlobalConfig::$CONNECTION_SETTING->Password = "Er1par2!";
...
/** the root url of the application with trailing slash, for example http://localhost/car reliability-inator / */
GlobalConfig::$ROOT_URL = RequestUtil::GetServerRootUrl() . 'cars/';
